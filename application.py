...
import warnings
# Suppress only DeprecationWarnings from Streamlit
...
if predicted_species=="setosa":
    st.image("res/setosa.jpg","Iris Setosa",width=400)
    ...
    st.image("res/virginica.jpg","Iris Virginica",width=400)
    ...
    st.image("res/versicolor.jpeg","Iris Versicolor",width=400)
